...
def sample(list_checkpoint_path, FILE_NAME):
    ...
    with open(os.path.join(os.path.dirname(__file__),FILE_NAME), 'wb') as f:
        pickle.dump({"all_agents_10_scenarios":all_agents_10_scenarios}, f)
...
#     FILE_NAME = "all_agents_all_scenarios_ppo_scenario_revised.pickle"
...
if not os.path.isfile(os.path.join(os.path.dirname(__file__),"all_agents_all_scenarios_alphazero_scenario_revised_10.pickle")):
    FILE_NAME = "all_agents_all_scenarios_alphazero_scenario_revised_10.pickle"
