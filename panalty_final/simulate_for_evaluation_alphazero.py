...
if not os.path.isfile(os.path.join(os.path.dirname(__file__),"all_agents_all_scenarios_alphazero_scenario_revised.pickle")):
    FILE_NAME = "all_agents_all_scenarios_alphazero_scenario_revised.pickle"
