...
class PPO(Algorithm):
    ...
    def get_default_policy_class(
        ...
        if config["framework"] == "torch":
            ...
            from test_ppo_220.ppo_tf_policy import PPOTF1Policy

            return PPOTF1Policy
        else:
            from test_ppo_220.ppo_tf_policy import PPOTF2Policy
...
# Deprecated: Use test_ppo_220.PPOConfig instead!
class _deprecated_default_config(dict):
    ...
    @Deprecated(
        ...
        new="test_ppo_220.ppo::PPOConfig(...)",
        error=True,
    )
