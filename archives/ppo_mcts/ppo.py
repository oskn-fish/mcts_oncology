...
class PPOMctsDefaultCallbacks(DefaultCallbacks):
    """AlphaZero callbacks.
    ...
    def on_episode_step(self, worker, base_env, policies, episode, env_index, **kwargs):
        # Save environment's state when an episode starts.
        env = base_env.get_sub_environments()[0]
        episode.user_data["on_episode_step_last_obs"] = env.last_obs
...
class PPOConfig(PGConfig):
    ...
    Example:
        >>> from ppo_mcts import PPOConfig
    ...
    def __init__(self, algo_class=None):
        ...
        """added"""
        self.callbacks_class = PPOMctsDefaultCallbacks
        self.mcts_config = {
    ...
    def training(
        ...
        *,
        ...
        mcts_on: Optional[bool] = NotProvided,
        **kwargs,
    ) -> "PPOConfig":
        ...
        if mcts_on is not NotProvided:
            self.mcts_on = mcts_on
...
class PPO(Algorithm):
    ...
    def get_default_policy_class(
        ...
        if config["framework"] == "torch":
            ...
            from ppo_mcts.ppo_tf_policy import PPOTF1Policy

            return PPOTF1Policy
        else:
            from ppo_mcts.ppo_tf_policy import PPOTF2Policy
...
# Deprecated: Use ppo_mcts.PPOConfig instead!
