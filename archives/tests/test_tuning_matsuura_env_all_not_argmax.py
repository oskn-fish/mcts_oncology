...
tuner = tune.Tuner(
    ...
    run_config = air.RunConfig(
        callbacks = [WandbLoggerCallback(project="no_early_stop_with_prediction_on_matsuura_not_argmax", api_key_file=os.path.join(os.path.dirname(__file__), "wandb_api_key.txt"))],
